...
export class ContactComponent {
  ...
  constructor(private applicantDataService: ApplicantDataCreateService, private router: Router, private applicantMailService: ApplicantMailService) {
  ...
  workExpFieldYes = true;
  workExpFieldNo = true;
  currentEmployerFieldYes = true;
  currentEmployerFieldNo = true;
